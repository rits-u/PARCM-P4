...
void MeshRenderer::init()
{
	...
	if (!isInitialized)
	{
		...
		renderSystem->compileVertexShader(L"..\\..\\..\\src_client\\App\\VertexShader.hlsl", "vsmain", &bytecode, &sizeBytecode);
		...
		//pixel shader
		renderSystem->compilePixelShader(L"..\\..\\..\\src_client\\App\\PixelShader.hlsl", "psmain", &bytecode, &sizeBytecode);
